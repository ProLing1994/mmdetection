...
epoch=epoch_20
model_root=/yuanhuan/model/image/mm_grounding_dino/mm_grounding_dino_l_capture_c28_2025_06_25
config=$model_root/grounding_dino_swin-l_finetune_capture_rm_c28.py
checkpoint=$model_root/$epoch.pth

image_paths=(
    "/yuanhuan/data/image/RM_Capture/training/Capture_C28_bicyclist_motorcyclist/"
    "/yuanhuan/data/image/RM_Capture/training/Capture_BSD_R151_bicyclist_motorcyclist/"
)
...
do
    ...
    python ./demo/image_demo_xml.py \
        ...
        --save-xml \
        --batch-size 1 \
        --texts 'bicyclist . motorcyclist . person .' 
