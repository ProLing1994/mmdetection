...
./tools/dist_train.sh configs/mm_grounding_dino/rm/grounding_dino_swin-l_finetune_capture_rm_c28.py 2 --work-dir /yuanhuan/model/image/mm_grounding_dino/mm_grounding_dino_l_capture_c28_2025_06_25