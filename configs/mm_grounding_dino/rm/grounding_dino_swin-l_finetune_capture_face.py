...
data_root = '/yuanhuan/data/image/RM_Face/training/Capture_Face_1w_3k_split_wzhedang/'
class_name = ('front_face', 'side_face', 'face_occlusion', 'person', 'bicyclist', 'motorcyclist',)
...
train_dataloader = dict(
    ...
    dataset=dict(
        data_root=data_root,
        metainfo=metainfo,
        ann_file='/yuanhuan/data/image/RM_Face/training/Capture_Face_1w_3k_split_wzhedang/train.json',
...
val_evaluator = dict(ann_file='/yuanhuan/data/image/RM_Face/training/Capture_Face_1w_3k_split_wzhedang/train.json')
...
work_dir = 'mm_grounding_dino_l_capture_face'