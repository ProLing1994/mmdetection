...
class_name = ('bicyclist', 'motorcyclist', 'person',)
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        metainfo=metainfo,
        split_names=[
                  'Capture_BSD_R151_bicyclist_motorcyclist',
                  'Capture_C28_bicyclist_motorcyclist',
                  ],
        ann_name='train.json',
        ann_cls="",
...
val_evaluator = dict(ann_file='/yuanhuan/data/image/RM_Capture/training//Capture_C28_bicyclist_motorcyclist/test.json')
...
train_cfg = dict(max_epochs=max_epoch, val_interval=30)
