...
from .rm_coco import RMCocoDataset
...
from .avm_coco import AvmCocoDataset

__all__ = [
    'XMLDataset', 'CocoDataset', 'RMCocoDataset', 'DeepFashionDataset', 'VOCDataset',
    ...
    'CustomSampleSizeSampler', 'Flickr30kDataset', 'AvmCocoDataset'
]
